                        ...
                        <div className="pt-16 pb-8 lg:pt-0">
                            ...
                            <div className="">
                                ...
                                <div className="flex flex-row justify-between items-center pt-5 mb-4">
                                    ...
                                    <Button onClick={() => props.setOpenModal(urls.stable_old)} className="float-right w-40 font-bold text-blue-light hover:text-blue-light 
                                    hover:bg-white border-2 border-blue-light">Download</Button>
                                </div>
