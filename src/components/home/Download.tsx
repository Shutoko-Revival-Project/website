                        ...
                        <div className="pt-16 pb-8 lg:pt-0">
                            ...
                            <div className="">
                                <div className="flex flex-row justify-between items-center mb-2">
                                    <span className="text-xl text-gray-300">Stable Release </span><span id="version-stable">0.9.1</span>
                                ...
                                <div className="flex flex-row justify-between items-center pt-5 mb-4">
                                    <span className="text-xl text-gray-300">Public Testing Build </span><span id="version-ptb">0.9.3 PTB2</span>
                                    <Button
